  ...
  return (
    <div style={{ maxWidth: '680px', margin: '0 auto', padding: '3rem 1.5rem', boxSizing: 'border-box' }}>
      ...
      <Detail title="How questions are selected and curated">
        <p>Questions on senseUS are editorially selected by the senseUS team. They span six categories: Fun, Hot Take, Deep, Topical, Tracking, and Sponsored.</p>
        <p style={{ marginTop: '0.75rem' }}>Questions are served in a balanced rotation based on the ratio of questions available in each category — so if we have more Deep questions than Fun questions, you'll see proportionally more Deep questions, but you'll still see both. Within each category, questions are served randomly.</p>
        <p style={{ marginTop: '0.75rem' }}>Sponsored questions are asked on behalf of verified business partners. They are clearly labeled. The data from sponsored questions is subject to the same integrity protections as all other questions — sponsors cannot influence results, suppress answers, or receive individual user data.</p>
