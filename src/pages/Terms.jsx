      ...
      {[
        {
          ...
          content: 'By creating an account or using senseUS ("the platform"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use senseUS. senseUS is a Delaware Public Benefit Corporation ("we," "us," or "our").'
        },
        {
          title: '2. Eligibility',
